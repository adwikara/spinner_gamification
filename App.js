...
const wheelCircle = wheelSize*1.1
const fontSize = 10;
const oneTurn = 360;
...
const wheelX = -180
const wheelY = 40
const product_list = ["Filma(1L)","TS Point","Blueband(200g)","TS Point", "Rootbeer","Pristine","TS Point", "Filma Margarine","Zoda","Zonk"]
...
const makeWheel = () => {
  ...
  return arcs.map((arc, index) => {
    ...
    return {
      ...
      value: product_list[index],//Math.round(Math.random() * 10 + 1) * 10, //[200, 2200]
    ...
    return (
      ...
      >
        <View style={styles.container}>
          ...
          <Image
            source={require("./app/img/pointer.png")}
          ...
          >
            <G y={width/2} x={width/2}>
              {this._wheelPaths.map((arc, i) => {
                ...
                const content = arc.value.toString();
